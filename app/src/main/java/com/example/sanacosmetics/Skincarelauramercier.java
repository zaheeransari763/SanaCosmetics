...
public class Skincarelauramercier extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skincarelauramercier);
            ...
            public void onClick(View v) {
                ...
                orderRef.child(buyersRandomKeyGen).updateChildren(orderMap).addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            Toast.makeText(Skincarelauramercier.this, "Order placed!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });

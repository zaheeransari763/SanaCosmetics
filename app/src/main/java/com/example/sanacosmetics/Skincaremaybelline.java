...
public class Skincaremaybelline extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skincaremaybelline);
            ...
            public void onClick(View v) {
                ...
                orderRef.child(buyersRandomKeyGen).updateChildren(orderMap).addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            Toast.makeText(Skincaremaybelline.this, "Order placed!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });

...
public class Skincareguerlain extends AppCompatActivity {
    public EditText royalQtyText,dailyQtyText,youthQtyText,superQtyText,lateQtyText;
    ...
    public int latesingleprice= 450,latefinalprice,lateprice;

    Button buyRoyal,buyDaily,buyYouth,buySuper,buyLate;
    ...
    public String latepricestring,productnamelate;

    String royalQtystr,dailyQtystr,youthQtystr,superQtystr,lateQtystr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skincareguerlain);
        ...
        lateQtyText=findViewById(R.id.lateQty);



        buyLate=findViewById(R.id.buyLate);
        buyLate.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                orderRef.child(buyersRandomKeyGen).updateChildren(orderMap).addOnCompleteListener(new OnCompleteListener<Void>()
                {
                    ...
                    public void onComplete(@NonNull Task<Void> task)
                    {
                        ...
                        {
                            Toast.makeText(Skincareguerlain.this, "Order placed!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void buyLate() {
        lateQtystr = lateQtyText.getText().toString();
        lateprice=Integer.parseInt(lateQtystr);
        latefinalprice=lateprice*latesingleprice;
        latepricestring=String.valueOf(latefinalprice);
        productnamelate="Late Night Recovery Treatment";
        ...
        orderMap.put("Contact",phone);
        orderMap.put("Address",address);
        orderMap.put("OrderQty",lateQtystr);
        orderMap.put("Price",latepricestring);
        orderMap.put("Item Name",productnamelate);
        orderMap.put("time",saveCurrentUserTime);
        orderMap.put("date",saveCurrentUserDate);
        orderMap.put("buyerOrderId",buyersRandomKeyGen);
        orderRef.child(buyersRandomKeyGen).updateChildren(orderMap).addOnCompleteListener(new OnCompleteListener<Void>()
